...
_PROOF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quorum_hash', full_name='org.dash.platform.dapi.v0.Proof.quorum_hash', index=2,
