...
_STORETREEPROOFS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='state_transition_proof', full_name='org.dash.platform.dapi.v0.StoreTreeProofs.state_transition_proof', index=4,
